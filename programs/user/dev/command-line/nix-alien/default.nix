...
let
  ...
  is-alien-available = if cfg.enable && !(hasAttr "nix-alien" self.inputs) then builtins.warn "> nix-alien cannot be enabled, it's not added in inputs" false else true;
in
{
